...
* Le règles d'intégrité formulées avec les fonctions étendues `areAreas2` et `areAreas3` ( <<references.adoc#6,[6]>>) doivent également être validées
|*Référence*|<<references.adoc#1,[1]>> Chap. 2.6, 2.8.12, 2.8.12.2, 2.8.13, 2.12, 2.14 et 3.3.11.13, <<references.adoc#6,[6]>>
|===
...
|===
|*ID*|*RSU.T17*
|*Désignation*|*Surfaces simples et partitions de territoire : `areAreas`*
|*Description*|Le test doit vérifier si les polygones sont conformes à la définition `areAreas`.
|*Condition préalable au test*|
...
|*Exemple*|
|*Résultat attendu*|
* RSU.T17a.xtf: message d'erreur. Violation de la règle d'integrité
* RSU.T17b.xtf: aucun message d'erreur
* RSU.T17c.xtf: aucun message d'erreur
* RSU.T17d.xtf: message d'erreur. Violation de la règle d'integrité
...
|===
|*ID*|*RSU.T18*
|*Désignation*|*Surfaces simples et partitions de territoire : `areAreas2`*
|*Description*|Le test doit vérifier si les polygones sont conformes à la définition `areAreas2`.
|*Condition préalable au test*|
...
|*Exemple*|image:../img/rsu.t18.png[]
|*Résultat attendu*|
* RSU.T18a.xtf: message d'erreur. Violation de la règle d'integrité
* RSU.T18b.xtf: message d'erreur. Violation de la règle d'integrité
* RSU.T18c.xtf: message d'erreur. Violation de la règle d'integrité
* RSU.T18d.xtf: aucun message d'erreur
* RSU.T18e.xtf: message d'erreur. Violation de la règle d'integrité
|*Référence*|<<references.adoc#6,[6]>>
|===
...
|===
|*ID*|*RSU.T19*
|*Désignation*|*Surfaces simples et partitions de territoire : `areAreas3`*
|*Description*|Le test doit vérifier si les polygones sont conformes à la définition `areAreas3`.
|*Condition préalable au test*|
...
|*Exemple*|image:../img/rsu.t19.png[]
|*Résultat attendu*|
* RSU.T19a.xtf: message d'erreur. Violation de la règle d'integrité
* RSU.T19b.xtf: message d'erreur. Violation de la règle d'integrité
* RSU.T19c.xtf: message d'erreur. Violation de la règle d'integrité
* RSU.T19d.xtf: message d'erreur. Violation de la règle d'integrité
* RSU.T19e.xtf: aucun message d'erreur
|*Référence*|<<references.adoc#6,[6]>>
|===
