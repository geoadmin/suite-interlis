...
|*Description*|Le test doit vérifier que les données soient conformes à la définition `ConstraintDef` du modèle de données INTERLIS
|*Condition préalable au test*|
link:https://raw.githubusercontent.com/geoadmin/suite-interlis/master/data/RKo.T07a.xtf[RKo.T11a.xtf],
link:https://raw.githubusercontent.com/geoadmin/suite-interlis/master/data/RKo.T07b.xtf[RKo.T11b.xtf]
|*Résultat attendu*|
